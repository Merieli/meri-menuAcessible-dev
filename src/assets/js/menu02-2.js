(() => {
    ...
    Menubar.prototype.setFocusToItem = function (newItem) {
        ...
        for (var i = 0; i < numItems; i++) {
            ...
            if (objectMenubarItem.domNode.tabIndex == 0) {
                flag =
                    $(objectMenubarItem.domNode).attr("aria-expanded") ===
                    "true";
            }
    ...
    if (width <= 768) {
        ...
        let menu = document.querySelector('[data-menu="acessible"]');
        ...
        let menubar = new Menubar(
            document.querySelector('[data-menu="acessible"]')
        );
        menubar.init();
    }
})();
